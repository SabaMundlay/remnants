...
1. Marsh_and_others_Digital_Play.pdf: academic text used for narrative development 
2. Okeowo_Saidiya_Hartman.pdf:  academic text used for narrative development 
3. Voss_Improv_Babel.pdf:  article used in brainstorming process
4. game_layout.png: part of game output
5. in_class_notes.pdf: notes taken during the IP course
6. rulebook.png: part of game output
